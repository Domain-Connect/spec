...
- Moved display-related and UX behavioral requirements out of field definitions into <<user_authorization_of_changes,format=title>>; reworded developer-only fields to express intent rather than normative prohibition.
