...
A value of empty or `"@"` indicates the host and domain name being applied (i.e., `"[host.]example.com"`). +

For any unspecified record type, this field contains the canonical presentation format of the record, following <<RFC3597>> generic or type-specific encoding. It MUST NOT be present in a template record for any record type that has type-specific data fields defined in this specification.
...
// TODO: the syntax for parameter values is not yet defined
...
* [[[RFC8126,RFC 8126]]] Cotton, M., Leiba, B., and T. Narten, "Guidelines for Writing an IANA Considerations Section in RFCs", IETF, BCP 26, RFC 8126, DOI 10.17487/RFC8126, June 2017, <https://www.rfc-editor.org/info/rfc8126>.
