...
- Marked the `"width"` and `"height"` <<dns-provider-discovery,format=title>> settings properties as Reserved, deferring their definition to <<DC-SPEC>>; removed reserved properties from the example settings response.
