...
// ============================================================
// RAW GIT DIFF — source material for async extension draft
// This file contains the verbatim output of:
//   git show 1bd7aab -- draft-ietf-dconn-domainconnect-02.adoc
// Lines prefixed with "-" are content removed from the base
// draft (i.e. async content to be restored here).
// Lines prefixed with "+" are the replacement text in the
// base draft (kept for context).
// Context lines (no prefix) are unchanged in both documents.
// ============================================================

commit 1bd7aab450e33a097785a8de63a0d4092a122cd2
Author: Pawel Kowalik <pawel-kow@users.noreply.github.com>
Date:   Sun May 31 16:20:19 2026 +0000

    WIP: async content removed from main (now sync) draft)

diff --git a/draft-ietf-dconn-domainconnect-02.adoc b/draft-ietf-dconn-domainconnect-02.adoc
index 67bf132..035bc6d 100644
--- a/draft-ietf-dconn-domainconnect-02.adoc
+++ b/draft-ietf-dconn-domainconnect-02.adoc
// === DIFF: Use Cases ===
@@ -70,7 +70,7 @@ The following use cases illustrate the wide range of applications where Domain C
...
// === DIFF: Use Cases out of scope ===
@@ -82,7 +82,7 @@ The following use cases illustrate the wide range of applications where Domain C
...
// === DIFF: Terminology — imported terms (client_id, response_type) ===
@@ -111,8 +111,6 @@ The following definitions and rules are imported normatively from other document
...
// === DIFF: ABNF — dc-scope rule ===
@@ -139,12 +137,6 @@ dc-id-list     =  dc-id *( "," dc-id )
...
// === DIFF: ABNF — dc-force rule ===
@@ -176,10 +168,6 @@ dc-description-text =  0*2048unicode-assignable
...
// === DIFF: Terminology prose — reserved-for-extensions added to base ===
@@ -286,6 +274,9 @@ User:: Refers to the end-user who has means to control domain name's DNS configu
...
+
 ...
 == Protocol design
// === DIFF: Protocol Flows — intro paragraph (two-flow description) ===
@@ -314,11 +305,7 @@ To attach a domain name to a service provided by a Service Provider, the user wo
...
// === DIFF: §4.3 The Asynchronous Flow — sequence diagram and steps ===
@@ -438,76 +425,6 @@ Steps:
...
// === DIFF: Template fields — serviceId description, syncBlock ===
@@ -544,7 +461,7 @@ The value MUST conform to the `dc-display-name` syntax (see <<terminology>>).
 |String
 |serviceId
...
// === DIFF: Template fields — syncBlock description ===
@@ -593,7 +510,7 @@ The value MUST conform to the `dc-description-text` syntax (see <<terminology>>)
 |*Synchronous Block*
 |Boolean
 |syncBlock
...
// === DIFF: Template Scope and Sub Domains descriptions ===
@@ -897,13 +814,13 @@ The following table lists the fields that MAY be defined for each record type. O
 [[template-scope]]
 ==== Template Scope
...
// === DIFF: Settings response — urlAsyncUX field definition ===
@@ -1113,11 +1030,7 @@ The URI MAY include a path component.
...
+|(Reserved. See <<reserved-for-extensions>>.)
 ...
 |*API URL Prefix*
 |urlAPI
// === DIFF: Endpoints section — async OAuth flow mention ===
@@ -1226,9 +1139,7 @@ discovery are in the form of URLs.
...
// === DIFF: §6.4 Asynchronous Flow: OAuth (all subsections) ===
@@ -1551,601 +1462,12 @@ As a RECOMMENDED convention, when the user explicitly cancels the operation and
...
// === DIFF: §9.1 OAuth Client Secret Leakage (Security Considerations) ===
@@ -2448,18 +1770,6 @@ Examples of template processing are in <<examples>>.
...
// === DIFF: IANA registry — Reserved status value and urlAsyncUX row ===
@@ -2499,6 +1809,7 @@ Each entry in the registry MUST include:
...
@@ -2532,7 +1843,7 @@ The following properties from this specification constitute the initial contents
 |This document
...
// === DIFF: Change History — -02 to -03 entry added to base ===
@@ -2610,6 +1921,15 @@ The authors wish to thank the following persons for their feedback and suggestio
...
// === DIFF: References — RFC7591 removed, DC-SPEC added to base ===
@@ -2696,7 +2016,7 @@ The authors wish to thank the following persons for their feedback and suggestio
